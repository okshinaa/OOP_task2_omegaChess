...
import ru.vsu.cs.okshina_v_a.GUI.GUIBoard;
...
public class Pawn extends Piece {
    ...
    public Piece promotionQuery(Coordinate promotionSquare) {
        ...
        while (!correctInput) {
            ...
            switch (promoted) {
                ...
                case "Champion", "C" -> {
                    promote = new Champion(getColour(), promotionSquare);
                    correctInput = true;
                }
                case "Rook", "R" -> {
    ...
    public void GUIPromotionQuery (Coordinate promotionSquare) {
        ...
        if (this.getColour() == COLOUR.B) {
            championOption = new JButton(new ImageIcon("BChampion.png"));
            ...
            championOption = new JButton(new ImageIcon("WChampion.png"));
        ...
        GUIBoard.formatInvisibleButton(championOption);
        ...
        Object[] options = {"OK",championOption, knightOption,bishopOption,rookOption,queenOption};
        championOption.addActionListener(actionEvent -> promotedPiece = new Champion(getColour(),promotionSquare));
